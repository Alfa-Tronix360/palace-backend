...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://localhost:3000",
        "http://127.0.0.1:3000",
        "https://palace-frontend.vercel.app",
        "https://noa-frontend-xamv.vercel.app",
    ],
    allow_origin_regex=r"https://(palace-frontend(-[a-z0-9]+)?|noa-frontend(-[a-z0-9]+)?)\.vercel\.app|http://(localhost|127\.0\.0\.1):\d+",
